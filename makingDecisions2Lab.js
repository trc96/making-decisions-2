...
//Code Here
let backwardsLetters = letters.reverse();
...
switch (letterGrade) {
  ...
  case 'F':
    ...
    break;
  default:
    console.log('Not an eligibile grade.')
}
...
/* The famous FizzBuzz, Devmountain style!
  ...
  If the number is divisible by 5, console.log 'mountain'. If the number is divisible by 5 & 3, console.log 'Devmountain'. If the number is not divisible by 5 or 3, console.
  log the number itself. Hint: Look up the modulo operator.
